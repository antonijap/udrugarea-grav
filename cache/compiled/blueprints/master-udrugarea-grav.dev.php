...
return [
    ...
    'checksum' => 'a38bf95861fc2027874ed456e27f4c82',
    'files' => [
        ...
        'user/plugins' => [
            ...
            'plugins/minify-html' => [
                'file' => 'user/plugins/minify-html/blueprints.yaml',
                'modified' => 1499449489
            ],
            'plugins/problems' => [
            ...
            'plugins/srcset' => [
                'file' => 'user/plugins/srcset/blueprints.yaml',
                'modified' => 1499449489
            ],
            'plugins/youtube' => [
    ...
    'data' => [
        'items' => [
            ...
            'plugins.autoseo.enabled' => [
                ...
                'name' => 'plugins.autoseo.enabled',
                'validation' => 'strict'
            ],
            'plugins.autoseo.global' => [
                'type' => 'section',
                'underline' => 1,
                'name' => 'plugins.autoseo.global',
                'validation' => 'strict'
            ],
            'plugins.autoseo.description' => [
                'type' => '_parent',
                'name' => 'plugins.autoseo.description',
                'form_field' => false
            ],
            'plugins.autoseo.description.enabled' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.autoseo.description.enabled',
                'validation' => 'strict'
            ],
            'plugins.autoseo.description.length' => [
                'type' => 'text',
                'size' => 'x-small',
                ...
                'name' => 'plugins.autoseo.description.length',
                'validation' => 'strict'
            ],
            'plugins.autoseo.keyword' => [
                'type' => '_parent',
                'name' => 'plugins.autoseo.keyword',
                'form_field' => false
            ],
            'plugins.autoseo.keyword.enabled' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.autoseo.keyword.enabled',
                'validation' => 'strict'
            ],
            'plugins.autoseo.keyword.length' => [
                'type' => 'text',
                'size' => 'x-small',
                ...
                'name' => 'plugins.autoseo.keyword.length',
                'validation' => 'strict'
            ],
            'plugins.autoseo.metadata' => [
                'type' => 'section',
                'underline' => 1,
                'name' => 'plugins.autoseo.metadata',
                'validation' => 'strict'
            ],
            'plugins.breadcrumbs' => [
                'form' => [
            ...
            'plugins.minify-html.enabled' => [
                ...
                'name' => 'plugins.minify-html.enabled',
                'validation' => 'strict'
            ],
            'plugins.minify-html.mincss' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.minify-html.mincss',
                'validation' => 'strict'
            ],
            'plugins.minify-html.minjs' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.minify-html.minjs',
                'validation' => 'strict'
            ],
            'plugins.minify-html.settings' => [
                'type' => 'section',
                'name' => 'plugins.minify-html.settings',
                'validation' => 'strict'
            ],
            'plugins.problems' => [
                'form' => [
            ...
            'plugins.social-meta-tags.plugin' => [
                'type' => 'tab',
                'name' => 'plugins.social-meta-tags.plugin',
                'validation' => 'strict'
            ],
            ...
            'plugins.social-meta-tags.twitter' => [
                'type' => 'tab',
                'name' => 'plugins.social-meta-tags.twitter',
                'validation' => 'strict'
            ],
            ...
            'plugins.social-meta-tags.facebook' => [
                'type' => 'tab',
                'name' => 'plugins.social-meta-tags.facebook',
                'validation' => 'strict'
            ],
            'plugins.social-meta-tags.social_pages_types' => [
                'type' => 'tabs',
                'active' => 1,
                'name' => 'plugins.social-meta-tags.social_pages_types',
                'validation' => 'strict'
            ],
            'plugins.srcset' => [
                'form' => [
            ...
            'plugins.srcset.enabled' => [
                ...
                'name' => 'plugins.srcset.enabled',
                'validation' => 'strict'
            ],
            'plugins.srcset.active' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.srcset.active',
                'validation' => 'strict'
            ],
            'plugins.srcset.maxWidth' => [
                'type' => 'number',
                'label' => 'Maximum Width',
                'name' => 'plugins.srcset.maxWidth',
                'validation' => 'strict'
            ],
            'plugins.srcset.minWidth' => [
                'type' => 'number',
                'label' => 'Minimum Width',
                'name' => 'plugins.srcset.minWidth',
                'validation' => 'strict'
            ],
            'plugins.srcset.stepSize' => [
                'type' => 'number',
                'label' => 'Step Size',
                'name' => 'plugins.srcset.stepSize',
                'validation' => 'strict'
            ],
            'plugins.srcset.defaultImageSize' => [
                'type' => 'text',
                'label' => 'Default Image Size',
                'default' => '100vw',
                'name' => 'plugins.srcset.defaultImageSize',
                'validation' => 'strict'
            ],
            'plugins.srcset.size' => [
                'type' => 'list',
                ...
                'name' => 'plugins.srcset.size',
                'validation' => 'strict'
            ],
            'plugins.srcset.size.screenSize' => [
                'type' => 'text',
                'label' => 'Screen Size',
                'name' => 'plugins.srcset.size.screenSize',
                'validation' => 'strict'
            ],
            'plugins.srcset.size.imageSize' => [
                'type' => 'text',
                'label' => 'Image Size',
                'name' => 'plugins.srcset.size.imageSize',
                'validation' => 'strict'
            ],
            'plugins.youtube' => [
                'form' => [
        ...
        'nested' => [
            ...
            'plugins' => [
                ...
                'autoseo' => [
                    'global' => 'plugins.autoseo.global',
                    'enabled' => 'plugins.autoseo.enabled',
                    'metadata' => 'plugins.autoseo.metadata',
                    'description' => [
                        'enabled' => 'plugins.autoseo.description.enabled',
                        'length' => 'plugins.autoseo.description.length'
                    ],
                    'keyword' => [
                        'enabled' => 'plugins.autoseo.keyword.enabled',
                        'length' => 'plugins.autoseo.keyword.length'
                    ]
                ],
                'breadcrumbs' => [
                ...
                'minify-html' => [
                    'settings' => 'plugins.minify-html.settings',
                    'enabled' => 'plugins.minify-html.enabled',
                    'mincss' => 'plugins.minify-html.mincss',
                    'minjs' => 'plugins.minify-html.minjs'
                ],
                'problems' => [
                ...
                'social-meta-tags' => [
                    'social_pages_types' => 'plugins.social-meta-tags.social_pages_types',
                    'plugin' => 'plugins.social-meta-tags.plugin',
                    'enabled' => 'plugins.social-meta-tags.enabled',
                    'twitter' => 'plugins.social-meta-tags.twitter',
                    'social_pages' => [
                        'pages' => [
                            'twitter' => [
                    ...
                    'facebook' => 'plugins.social-meta-tags.facebook'
                ],
                'srcset' => [
                    'enabled' => 'plugins.srcset.enabled',
                    'active' => 'plugins.srcset.active',
                    'maxWidth' => 'plugins.srcset.maxWidth',
                    'minWidth' => 'plugins.srcset.minWidth',
                    'stepSize' => 'plugins.srcset.stepSize',
                    'defaultImageSize' => 'plugins.srcset.defaultImageSize',
                    'size' => [
                        'screenSize' => 'plugins.srcset.size.screenSize',
                        'imageSize' => 'plugins.srcset.size.imageSize'
                    ]
                ],
                'youtube' => [
